...
# /Library/PostgreSQL/9.1/bin/pg_dump -U postgres diploma_production > backup/100_100_REWRITE_SHINGLE_LENGTH_3_new.backup
# 
# echo "60"
# rake db:drop db:create RAILS_ENV=production --trace &&
# psql -U postgres diploma_production < backup/DEFAULT_SHINGLE_LENGTH_3_new.backup &&
...
rake rewrite_documents:create_report RAILS_ENV=production --trace &&
/Library/PostgreSQL/9.1/bin/pg_dump -U postgres diploma_production > backup/100_40_REWRITE_SHINGLE_LENGTH_3_new.backup
...
rake rewrite_documents:create_report RAILS_ENV=production --trace &&
/Library/PostgreSQL/9.1/bin/pg_dump -U postgres diploma_production > backup/100_20_REWRITE_SHINGLE_LENGTH_3_new.backup
...
rake rewrite_documents:create_report RAILS_ENV=production --trace &&
/Library/PostgreSQL/9.1/bin/pg_dump -U postgres diploma_production > backup/100_5_REWRITE_SHINGLE_LENGTH_3_new.backup
...
rake rewrite_documents:create_report RAILS_ENV=production --trace &&
/Library/PostgreSQL/9.1/bin/pg_dump -U postgres diploma_production > backup/100_ALPHABETIC_SHINGLE_LENGTH_3_new.backup
...
rake rewrite_documents:create_report RAILS_ENV=production --trace &&
/Library/PostgreSQL/9.1/bin/pg_dump -U postgres diploma_production > backup/100_SHUFFLE_SENTENCES_SHINGLE_LENGTH_3_new.backup
...
rake rewrite_documents:create_report RAILS_ENV=production --trace &&
/Library/PostgreSQL/9.1/bin/pg_dump -U postgres diploma_production > backup/100_SHUFFLE_PARAGRAPHS_SHINGLE_LENGTH_3_new.backup